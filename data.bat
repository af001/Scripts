...
REM Get Computer WIFI
for /f "usebackq tokens=3 delims=," %%a in (`getmac /fo csv /v ^| find "Wireless Network Connection"`) do set WIFI=%%~a
...
echo Wireless MAC Address: %WIFI%
echo --------------------------------------------
...
echo Wireless MAC Address: %WIFI% >> %file%
echo -------------------------------------------- >> %file%
